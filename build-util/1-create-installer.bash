...
#     tstool-campbellcloud-plugin-1.0.0-win-2206060102.zip
...
createPluginZipFile() {
  ...
  "${sevenzip}" a -tzip ${zipFile} "owf-tstool-campbellcloud-plugin/${pluginVersion}"
  exitStatus=$?
...
now=$(date +%Y%m%d%H%M)
zipFile="${distFolder}/tstool-campbellcloud-plugin-${pluginVersion}-win-${now}.zip"
