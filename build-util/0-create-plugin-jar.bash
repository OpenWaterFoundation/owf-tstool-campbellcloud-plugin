...
#
#     TSTool 15:
#       ./tstool/NN/plugins/owf-tstool-campbellcloud-plugin/1.0.0/
#
#     TSTool before version 15:
#       ./tstool/NN/plugins/owf-tstool-campbellcloud-plugin/
...
#mavenProjectFolder=${repoFolder}/owf-tstool-campbellcloud-plugin
...
devBinFolder="${repoFolder}/owf-tstool-campbellcloud-plugin/target/classes"
...
mainPluginFolder="${pluginsFolder}/owf-tstool-campbellcloud-plugin"

# Version installed folder for the plugin.
versionPluginFolder="${mainPluginFolder}/${pluginVersion}"

jarFile="${versionPluginFolder}/owf-tstool-campbellcloud-plugin-${pluginVersion}.jar"
manifestFile="${repoFolder}/owf-tstool-campbellcloud-plugin/src/main/resources/META-INF/MANIFEST.MF"
