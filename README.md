# owf-tstool-campbellcloud-plugin #

**This software is under development.**

This repository contains the Open Water Foundation TSTool Campbell Cloud web services plugin.
This plugin can be installed to enable commands that integrate TSTool with Campbell Cloud web services,
...
*   Campbell Cloud API Documentation:
    +   [Campbell Cloud API Documentation (1.0.0)](https://us-west-2.campbell-cloud.com/api/v1/docs/)
  ...
  cdss-dev/                                  Recommended folder for CDSS product development.
    TSTool/                                  Recommended folder for TSTool development.
      git-repos/                             Recommended folder for TSTool product repositories.
        owf-tstool-campbellcloud-plugin/    Repository working files.
          ...
          owf-tstool-campbellcloud-plugin/   Maven project source code and supporting files.
...
This section explains how to add the TSTool Campbell Cloud plugin to the TSTool core development environment.
...
6.  Browse to the `cdss-dev/TSTool/git-repos/owf-tstool-campbellcloud-plugin/owf-tstool-campbellcloud-plugin` folder
    and ***Select Folder***.
...
9.  Right click on `owf-tstool-campbellcloud-plugin` in ***Package Explorer*** or ***Project Explorer***
...
1.  Eclipse project:
    1.  The `owf-tstool-campbellcloud-plugin` repository is added as a Maven project.
...
2.  Plugin jar file:
    ...
    3.  The above script relies on the `owf-tstool-campbellcloud-plugin/src/main/resources/META-INF/MANIFEST.MF`
...
1.  Update the version:
    1.  Update the `src/main/java/owf-tstool-campbellcloud-plugin/org/openwaterfoundation/tstool/plugin/campbellcloud/PluginMeta.java` source file.
