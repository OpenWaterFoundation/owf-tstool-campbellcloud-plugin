// CampbellCloud_TimeSeries_CellRenderer - renderer for the time series catalog table model
...
/**
This class is used to render cells for CampbellCloud_TimeSeries_TableModel data.
*/
@SuppressWarnings("serial")
public class CampbellCloud_TimeSeries_CellRenderer extends JWorksheet_AbstractExcelCellRenderer {

	private CampbellCloud_TimeSeries_TableModel tableModel = null;

	/**
	Constructor.
	@param tableModel The CampbellCloud_TimeSeries_TableModel to render.
	*/
	public CampbellCloud_TimeSeries_CellRenderer ( CampbellCloud_TimeSeries_TableModel tableModel ) {
