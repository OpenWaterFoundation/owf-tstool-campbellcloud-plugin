...
package org.openwaterfoundation.tstool.plugin.campbellcloud;

public class PluginMeta {
	/**
	 * Plugin version.
	 */
	public static final String VERSION = "1.0.4 (2026-01-04)";
	...
	public static String getDocumentationRootUrl() {
		...
		String url = "https://software.openwaterfoundation.org/tstool-campbellcloud-plugin/latest/doc-user/";
		return url;
	}
