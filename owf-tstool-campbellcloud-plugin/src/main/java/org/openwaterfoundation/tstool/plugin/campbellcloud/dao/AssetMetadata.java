// AssetMetadata - results from list-assets service, "metadata" object
...
public class AssetMetadata {
	 ...
	 * "maint_mode"
	 */
	@JsonProperty("maint_mode")
	private Boolean maintMode = null;

	/**
	 * "auto_update"
	 */
	@JsonProperty("auto_update")
	private Map<String,Object> autoUpdate = null;
