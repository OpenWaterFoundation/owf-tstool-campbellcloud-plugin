# OWF / TSTool Campbell Cloud Data Plugin #

This is the user documentation for the Open Water Foundation TSTool
[Campbell Cloud](https://us-west-2.campbell-cloud.com/api/v1/docs/)
web services plugin.
This plugin allows Campbell Cloud time series to be listed and read.
...
*   TSTool Campbell Cloud plugin version 1.0.3
...
See the [TSTool Campbell Cloud Plugin](https://software.openwaterfoundation.org/tstool-campbellcloud-plugin/) download page.
