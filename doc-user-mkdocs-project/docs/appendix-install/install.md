# TSTool / Install Campbell Cloud Plugin #

This appendix describes how to install and configure the TSTool Campbell Cloud Plugin.

*   [Install TSTool](#install-tstool)
*   [Install and Configure the TSTool Campbell Cloud Web Services Plugin](#install-and-configure-the-tstool-campbell-cloud-web-services-plugin)

-------

## Install TSTool ##

TSTool must be installed before installing the Campbell Cloud plugin.
...
## Install and Configure the TSTool Campbell Cloud Web Services Plugin ##
...
/home/user/.tstool/NN/       (Linux)
  plugins/
    owf-tstool-campbellcloud-plugin/
      1.0.0/
        owf-tstool-campbellcloud-plugin-1.0.0.jar
        dep/
```
...
2.  Download the `tstool-campbellcloud-plugin` software installer file from the
    [TSTool Campbell Cloud Download page](https://software.openwaterfoundation.org/tstool-campbellcloud-plugin/).
    For example with a name similar to `tstool-campbellcloud-plugin-1.0.0-win-202509251628.zip`.
...
4.  Copy files from the `zip` file to the `owf-tstool-campbellcloud-plugin` folder as shown in the above example:
...
5.  Configure one or more datastore configuration files:
    *   See the
        [Campbell Cloud Web Services Datastore](../datastore-ref/CampbellCloud/CampbellCloud.md#datastore-configuration-file)
